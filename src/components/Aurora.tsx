/*
 * The atmospheric background behind the hero: two large, heavily blurred
 * colour fields on slow independent loops, over a faint graph-paper grid.
 *
 * Both fields are the one accent hue. An earlier version added a magenta third
 * blob, which turned the top of the page into a colour wash competing with the
 * headline for attention — the point of this layer is depth, not decoration.
 *
...
const Aurora = () => (
  ...
  >
    ...
    <div
      ...
      style={{
        background:
          "radial-gradient(circle at 50% 50%, hsl(var(--accent) / 0.24), transparent 68%)",
      }}
    />
    <div
      ...
      style={{
        background:
          "radial-gradient(circle at 50% 50%, hsl(var(--accent-2) / 0.18), transparent 68%)",
      }}
    />
